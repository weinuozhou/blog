...
* `Python` 基础
    * `Python` 基础教程
        * [Python入门](/Python0to1/base/intro)
        * [数据结构](/Python0to1/base/DataStructure)
        * [函数式编程](/Python0to1/base/function)
        * [面向对象编程](/Python0to1/base/oop)
        * [文件与IO](/Python0to1/base/FileIO.md)
        * [异常处理](/Python0to1/base/Exceptions)
        * [正则表达式](/Python0to1/base/regex)
        * [内置模块](/Python0to1/base/internalmodule)
    * 数据分析
        * [数据探索](/Python0to1/Analysis/数据探索)
        * [数据结构](/Python0to1/Analysis/数据结构)
        * [数据清洗与集成](/Python0to1/Analysis/数据清洗与集成)
        * [Numpy](/Python0to1/Analysis/numpy)
        * [PandasCheatSheet](/Python0to1/Analysis/PandasCheat)
    * 数据可视化
        * [Matplotlib](/Python0to1/Viewer/matplotlib)
        * [Pyecharts](/Python0to1/Viewer/pyecharts)
        * [Seaborn](/Python0to1/Viewer/seaborn)
    * `Python` 爬虫
        * [爬虫基础](/Python0to1/Spiders/preface)
        * [web前端知识](/Python0to1/Spiders/web)
        * [网络通讯](/Python0to1/Spiders/webConnect)
        * [发送请求](/Python0to1/Spiders/request)
        * [解析数据](/Python0to1/Spiders/parsel)
        * [Ajax数据请求](/Python0to1/Spiders/AjaxSpider)
        * [Selenium的使用](/Python0to1/Spiders/selenium)
        * [Splash的使用](/Python0to1/Spiders/splash)
        * [数据存储](/Python0to1/Spiders/saveData)
        * [Scrapy框架](/Python0to1/Spiders/scrapy)
    * 机器学习
